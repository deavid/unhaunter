...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke1_mut__h1d79991baf70734a: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h52dc48582f35ce72: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h7c6a222d95b780e8: (a: number, b: number, c: number, d: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h1d1b28cbdcf0ee9c: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h2baaee41dfaa4ed9: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h08e1e36a6bf4517d: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h7345e955f9078979: (a: number, b: number, c: number) => void;
