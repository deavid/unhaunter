...
impl Grade {
    ...
    pub fn color(&self) -> bevy::prelude::Color {
        ...
        match self {
            Grade::A => Color::srgb(0.0, 0.8, 0.0),
            Grade::B => Color::srgb(0.5, 0.8, 0.0),
            Grade::C => Color::srgb(1.0, 0.8, 0.0),
            Grade::D => Color::srgb(1.0, 0.5, 0.0),
            Grade::F => Color::srgb(1.0, 0.0, 0.0),
            Grade::NA => Color::srgb(0.5, 0.5, 0.5),
        }
    }
