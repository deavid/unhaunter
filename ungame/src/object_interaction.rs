//! This module defines the `GameConfig` struct, which stores global parameters for
//! the game, including those related to the object-ghost interaction system.
use bevy::prelude::*;
...
pub struct ObjectInteractionConfig {
    ...
    /// A multiplier for the discharge rate of Attractive objects when the ghost is
    /// nearby.
    pub attractive_discharge_multiplier: f32,
    /// A multiplier for the discharge rate of Repulsive objects when the ghost is
    /// nearby.
    ...
    /// A multiplier for the influence of Attractive objects on the ghost's destination
    /// score.
