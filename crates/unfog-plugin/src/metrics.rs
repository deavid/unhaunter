...
pub(crate) const SPAWN_MIASMA: DP = DP::const_new("unfog/systems/spawn_miasma");
pub(crate) const ANIMATE_MIASMA: DP = DP::const_new("unfog/systems/animate_miasma");
pub(crate) const UPDATE_MIASMA: DP = DP::const_new("unfog/systems/update_miasma");
