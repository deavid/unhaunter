...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke1_mut__h862743570b93ccf4: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h1edd832e50695b28: (a: number, b: number, c: number, d: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h0cee13cc57a40981: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__ha350debd4dc074af: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h95dee76a2edbe441: (a: number, b: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hd62fa6892f63721c: (a: number, b: number, c: number) => void;
