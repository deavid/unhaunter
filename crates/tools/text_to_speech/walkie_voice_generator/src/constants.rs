...
pub(crate) const WALKIE_PHRASES_DIR: &str = "tools/text_to_speech/walkie_phrases/";
...
pub(crate) const GENERATED_RUST_DIR: &str = "unwalkiecore/src/generated/";
...
pub(crate) const DURATION_SCRIPT_PATH: &str = "tools/text_to_speech/scripts/get_audio_duration.sh";
/// Directory for storing temporary audio files (e.g., intermediate WAV files).
pub(crate) const TEMP_AUDIO_DIR: &str = "tools/text_to_speech/temp_audio/";
