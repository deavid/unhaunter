...
**Unhaunter** is a **Nightmare Simulator**. To build it, we need to identify the architectural **Subsystems** required to support its gameplay loop.

This report analyzes 25 reference games to isolate the "Big Chunks" of functionality—the Subsystems—that the engine must provide.
