...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke1_mut__h4793a9a97d6451c0: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__hc6632823cce6b497: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h0c96cacf276fcd00: (a: number, b: number, c: number, d: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h13e62b4bf399df80: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__hbb472b858c5d379e: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__hbd9702b266f4050a: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__hf79fd0f793df5ff6: (a: number, b: number, c: number) => void;
