...
pub struct MissionAssets {
    ...
    pub background_noise_house: Handle<AudioSource>,
    #[asset(path = "sounds/ambient-clean.ogg")]
    pub ambient_clean: Handle<AudioSource>,
    #[asset(path = "sounds/heartbeat-1.ogg")]
    pub heartbeat: Handle<AudioSource>,
    #[asset(path = "sounds/heartbeat-2.ogg")]
    pub heartbeat_2: Handle<AudioSource>,
    #[asset(path = "sounds/insane-1.ogg")]
    pub insane: Handle<AudioSource>,
    ...
    pub door_creak_slow: Handle<AudioSource>,
    #[asset(path = "sounds/door-open.ogg")]
    pub door_open: Handle<AudioSource>,
    #[asset(path = "sounds/fadein-progress-1000ms.ogg")]
    pub fadein_progress: Handle<AudioSource>,
    #[asset(path = "sounds/fadein-progress-1500ms.ogg")]
    pub fadein_progress_1500: Handle<AudioSource>,
    #[asset(path = "sounds/effects-chirp-base.ogg")]
    pub effects_chirp_base: Handle<AudioSource>,
    #[asset(path = "sounds/effects-chirp-click.ogg")]
    pub effects_chirp_click: Handle<AudioSource>,
    #[asset(path = "sounds/effects-chirp-high.ogg")]
    pub effects_chirp_high: Handle<AudioSource>,
    #[asset(path = "sounds/effects-chirp-short.ogg")]
    pub effects_chirp_short: Handle<AudioSource>,
    #[asset(path = "sounds/effects-chirp-shorter.ogg")]
    pub effects_chirp_shorter: Handle<AudioSource>,
    #[asset(path = "sounds/effects-dingdingding.ogg")]
    pub effects_dingdingding: Handle<AudioSource>,
    #[asset(path = "sounds/effects-dongdongdong.ogg")]
    pub effects_dongdongdong: Handle<AudioSource>,
    #[asset(path = "sounds/effects-radio-answer1.ogg")]
    pub effects_radio_answer1: Handle<AudioSource>,
    #[asset(path = "sounds/effects-radio-answer2.ogg")]
    pub effects_radio_answer2: Handle<AudioSource>,
    #[asset(path = "sounds/effects-radio-answer3.ogg")]
    pub effects_radio_answer3: Handle<AudioSource>,
    #[asset(path = "sounds/effects-radio-answer4.ogg")]
    pub effects_radio_answer4: Handle<AudioSource>,
    #[asset(path = "sounds/effects-radio-scan.ogg")]
    pub effects_radio_scan: Handle<AudioSource>,
    #[asset(path = "sounds/ghost-effect-1.ogg")]
    pub ghost_effect_1: Handle<AudioSource>,
    #[asset(path = "sounds/ghost-effect-2.ogg")]
    pub ghost_effect_2: Handle<AudioSource>,
    #[asset(path = "sounds/ghost-effect-3.ogg")]
    pub ghost_effect_3: Handle<AudioSource>,
    #[asset(path = "sounds/ghost-effect-4.ogg")]
    pub ghost_effect_4: Handle<AudioSource>,
    #[asset(path = "sounds/ghost-roar-1.ogg")]
    pub ghost_roar_1: Handle<AudioSource>,
    #[asset(path = "sounds/ghost-roar-2.ogg")]
    pub ghost_roar_2: Handle<AudioSource>,
    #[asset(path = "sounds/ghost-roar-3.ogg")]
    pub ghost_roar_3: Handle<AudioSource>,
    #[asset(path = "sounds/ghost-roar-4.ogg")]
    pub ghost_roar_4: Handle<AudioSource>,
    #[asset(path = "sounds/ghost-snore-1.ogg")]
    pub ghost_snore_1: Handle<AudioSource>,
    #[asset(path = "sounds/ghost-snore-2.ogg")]
    pub ghost_snore_2: Handle<AudioSource>,
    #[asset(path = "sounds/ghost-snore-3.ogg")]
    pub ghost_snore_3: Handle<AudioSource>,
    #[asset(path = "sounds/ghost-snore-4.ogg")]
    pub ghost_snore_4: Handle<AudioSource>,
    #[asset(path = "sounds/hide-rustle.ogg")]
    pub hide_rustle: Handle<AudioSource>,
    #[asset(path = "sounds/impact_glass_shatter.ogg")]
    pub impact_glass_shatter: Handle<AudioSource>,
    #[asset(path = "sounds/impact_metal_clink.ogg")]
    pub impact_metal_clink: Handle<AudioSource>,
    #[asset(path = "sounds/impact_wood_thud.ogg")]
    pub impact_wood_thud: Handle<AudioSource>,
    #[asset(path = "sounds/invalid-action-buzz.ogg")]
    pub invalid_action_buzz: Handle<AudioSource>,
    #[asset(path = "sounds/item-drop-clunk.ogg")]
    pub item_drop_clunk: Handle<AudioSource>,
    #[asset(path = "sounds/item-drop-clunk-1.ogg")]
    pub item_drop_clunk_1: Handle<AudioSource>,
    #[asset(path = "sounds/item-move-scrape.ogg")]
    pub item_move_scrape: Handle<AudioSource>,
    #[asset(path = "sounds/item-pickup-whoosh.ogg")]
    pub item_pickup_whoosh: Handle<AudioSource>,
    #[asset(path = "sounds/object_drag_wood.ogg")]
    pub object_drag_wood: Handle<AudioSource>,
    #[asset(path = "sounds/object_nudge_1.ogg")]
    pub object_nudge_1: Handle<AudioSource>,
    #[asset(path = "sounds/object_throw_generic.ogg")]
    pub object_throw_generic: Handle<AudioSource>,
    #[asset(path = "sounds/quartz_crack.ogg")]
    pub quartz_crack: Handle<AudioSource>,
    #[asset(path = "sounds/radio-off-zzt.ogg")]
    pub radio_off_zzt: Handle<AudioSource>,
    #[asset(path = "sounds/radio-on-zzt.ogg")]
    pub radio_on_zzt: Handle<AudioSource>,
    #[asset(path = "sounds/sage_activation.ogg")]
    pub sage_activation: Handle<AudioSource>,
    #[asset(path = "sounds/salt_drop.ogg")]
    pub salt_drop: Handle<AudioSource>,
    #[asset(path = "sounds/door_lock_heavy.ogg")]
    pub door_lock_heavy: Handle<AudioSource>,
    #[asset(path = "sounds/switch-off-1.ogg")]
    pub switch_off_1: Handle<AudioSource>,
    #[asset(path = "sounds/switch-on-1.ogg")]
    pub switch_on_1: Handle<AudioSource>,
    #[asset(path = "sounds/switch-on-2.ogg")]
    pub switch_on: Handle<AudioSource>,
