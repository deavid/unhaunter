//! Difficulty enum definition
//!
//! This module contains the Difficulty enum and its basic utility methods.
//! The DifficultySettings trait implementation is in difficulty_impl.rs.
