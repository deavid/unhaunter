...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke1_mut__h887655c4ce873ba4: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h4b2f46ad965ceca0: (a: number, b: number, c: number, d: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h144379be77019218: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h48abe8daeb83291d: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__hf58a0e943f20ad6d: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__hf9f2bad1773d7d01: (a: number, b: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h62b2d2cf9b797107: (a: number, b: number, c: number) => void;
