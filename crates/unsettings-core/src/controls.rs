...
pub struct ControlKeys {
    ...
    pub left_hand_trigger: KeyCode,
    /// Key for triggering the right-hand item (e.g., EMF reader).
    pub right_hand_trigger: KeyCode,
...
impl Default for ControlKeys {
    fn default() -> Self {
        Self {
            ...
            right_hand_trigger: KeyCode::KeyR,
            left_hand_trigger: KeyCode::Tab,
            cycle: KeyCode::KeyQ,
            swap: KeyCode::KeyT,
            drop: KeyCode::KeyG,
            grab: KeyCode::KeyF,
...
impl ControlKeys {
    ...
    pub const NONE: Self = ControlKeys {
        ...
        left_hand_trigger: KeyCode::NonConvert,
        cycle: KeyCode::NonConvert,
        swap: KeyCode::NonConvert,
        grab: KeyCode::NonConvert,
        drop: KeyCode::NonConvert,
