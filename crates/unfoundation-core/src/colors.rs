...
// Note: Cannot use BorderColor::all() in const context, so we need to use a runtime constant or lazy_static
pub const DEBUG_BORDER_COLOR: Color = Color::srgba(0.0, 1.0, 1.0, 0.0003);
